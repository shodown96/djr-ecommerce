...
export const addressUpdateURL = (id: string | number) => `${endpoint}/addresses/${id}/update/`;
export const addressDeleteURL = (id: string | number) => `${endpoint}/addresses/${id}/delete/`;
