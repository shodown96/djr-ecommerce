...
import host, { productDetailURL, addToCartURL, orderItemDeleteURL } from "../constants";
        ...
        <MDBContainer className="">
            ...
            <MDBRow className="w-100">
                ...
                <MDBCol md="5" className="offset-md-1">
                                                ...
                                                <div key={i} className="row">
                                                    {v.item_variations.map((iv, i) =>
                                                        <div className="col-lg-4 mb-2" key={i}>
                                                            ...
                                                            {iv.attachment && <img src={`${host}${iv.attachment}`} alt="" className="img-fluid z-depth-1" />}
                                                        </div>
                                                    )}
                                                </div>
                                            </>
                    ...
                    {item?.variations?.length > 0 ?
                        <MDBBtn block onClick={handleToggleForm}>Add to Cart</MDBBtn>
